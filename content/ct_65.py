...
- Após o mapeamento do objeto do mundo real para sua representação computacional, pode-se criar quantos objetos forem necessários
- Os objetos/instâncias de uma classe são como variáveis do tipo definido na classe
'''
