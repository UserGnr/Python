...
Revisão sobre atributos privados
...
Esses elementos privados só devem/deveriam ser acessados dentro da classe. Mas o Python não bloqueia este acesso fora da classe. Com Python acontece um fenômeno chamado Name Mangling, que faz uma alteração na forma de se acessar os elementos privados, conforme:
    _Classe__elemento
'''
