...
- Possibilidade de uma classe herdar de múltiplas classes, fazendo com que a classe filha herde todos os atributos e métodos de todas as classes herdadas
...
class Pinguim(Aquatico, Terrestre):     # Os métodos com mesmo nome de aquático terão preferencia aos metodos de Terrestre 
